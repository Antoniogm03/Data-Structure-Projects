...
public :
    ...
    /**
     * @brief Genera una imagen en negativo.
     */
    void Invert();
     ...
     * @param in2 Umbreal superior de la imagen de entrada.
     * @param out1 Umbral inferior de la imagen de salida.
     * @param out2 Umbreal superior de la imagen de salida.
     * @pre 0 <= (in1, in2, out1, out2) <= 255
     * @pre in1 < in2
     * @pre out1 < out 2
     * @post El objeto al que llama la función es modificado.
     */
     ...
     * @param i Fila inicial para recortar.
     * @param j Columna inicial para recortar.
    ...
    /**
     * @brief Realiza un zoom x2 de una porción de la imagen.
     * @return Imagen con el zoom aplicado
     * @post La imagen resultante tendra unas dimensiones (2N-1) x (2N-1).
     */
    Image Zoom2X() const;
     ...
     * con las ﬁlas ordenadas según el siguiente algoritmo: ç = (r*p) % rows.
     */
    void ShuffleRows();
} ;
